  ...
  class SkillResolver
    ...
    def assigned_skills
      ...
      assignments
        ...
        .map { |assignment| skill_entry(assignment.agent_skill, assignment.priority) }
    ...
    def default_skill_entry
      skill_entry(AgentSkill.default_presales!, 50)
    end

    def skill_entry(skill, assignment_priority)
      {
        id: skill.id,
        key: skill.key,
        name: skill.name,
